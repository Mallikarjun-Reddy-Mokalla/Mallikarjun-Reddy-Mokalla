...
public class BirdAdapter extends RecyclerView.Adapter<BirdAdapter.ViewHolder> {
    public ArrayList<BirdUrl> birdUrl;
    ...
    public BirdAdapter(Context context, ArrayList<BirdUrl> birdlist) {
        this.birdUrl = birdlist;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        TextView bird_name;
        ImageView play_icon, pause_icon, bird_images;

        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            bird_name = (itemView).findViewById(R.id.animal_name);
            play_icon = (itemView).findViewById(R.id.play_icon);
            pause_icon = (itemView).findViewById(R.id.pause_icon);
            bird_images = (itemView).findViewById(R.id.animal_image);
    ...
    @NonNull
    @Override
    public BirdAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int i) {
        ...
        holder.itemView.setTag(birdUrl.get(i));
        holder.bird_name.setText(birdUrl.get(i).getBirdname());
        holder.bird_images.setImageResource(birdUrl.get(i).getBirdimage());
        ...
        holder.play_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    mediaPlayer.setDataSource("https://wirralvideos.s3.us-west-2.amazonaws.com/animal-sounds/birds/" + birdUrl.get(i).getURL());
//                    PlaypopDialig();
                    mediaPlayer.prepare();
                    mediaPlayer.start();
...
//
//                    try {
//                        mediaPlayer.setDataSource(birdUrl.get(i).getURL());
...
//                    }
        ...
        holder.bird_name.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String Url = ("https://wirralvideos.s3.us-west-2.amazonaws.com/animal-sounds/birds/" + birdUrl.get(i).getURL());

                Intent intent = new Intent(context, Playscreen.class);

                intent.putExtra("name", birdUrl.get(i).getBirdname());
                intent.putExtra("image", birdUrl.get(i).getBirdimage());
