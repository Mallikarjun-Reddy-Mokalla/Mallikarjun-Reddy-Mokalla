...
public class WildAnimalsAdapter extends RecyclerView.Adapter<WildAnimalsAdapter.ViewHolder> {
    Context context;
    ArrayList<Wildanimalsdata> wildanimalsdata;
    MediaPlayer mediaPlayer;
    MediaPlayer oldmediaPlayer;
    WildAnimalsAdapter.ViewHolder oldHolder;
    Activity activity;
    Dialog dialog;


    public WildAnimalsAdapter(Context context, ArrayList<Wildanimalsdata> wildanimalsdata) {
        this.context = context;
        this.wildanimalsdata = wildanimalsdata;
        this.activity = (Activity) context;

    }

    public class ViewHolder extends RecyclerView.ViewHolder {
        ImageView wildanimal_image, play_icon, pause_icon;
        TextView wildanimal_name;

        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            wildanimal_image = itemView.findViewById(R.id.animal_image);
            wildanimal_name = itemView.findViewById(R.id.animal_name);
    ...
    @NonNull
    @Override
    public WildAnimalsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull WildAnimalsAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int i) {
        holder.itemView.setTag(wildanimalsdata.get(i));
        holder.wildanimal_name.setText(wildanimalsdata.get(i).getWildanimalname());
        holder.wildanimal_image.setImageResource(wildanimalsdata.get(i).getWildanimalimage());
        ...
        holder.play_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                oldHolder = holder;
                try {
                    mediaPlayer.setDataSource("https://wirralvideos.s3.us-west-2.amazonaws.com/animal-sounds/wild-animals/" + wildanimalsdata.get(i).getWildanimalsound());
//                    PlaypopDialig();
                    mediaPlayer.prepare();
                    mediaPlayer.start();
        ...
        holder.wildanimal_name.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String Url = ("https://wirralvideos.s3.us-west-2.amazonaws.com/animal-sounds/wild-animals/" + wildanimalsdata.get(i).getWildanimalsound());

                Intent intent = new Intent(context, Playscreen.class);

                intent.putExtra("name", wildanimalsdata.get(i).getWildanimalname());
                intent.putExtra("image", wildanimalsdata.get(i).getWildanimalimage());
