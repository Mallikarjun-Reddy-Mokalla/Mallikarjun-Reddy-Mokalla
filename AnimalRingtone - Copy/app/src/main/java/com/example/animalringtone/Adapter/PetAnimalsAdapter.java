...
public class PetAnimalsAdapter extends RecyclerView.Adapter<PetAnimalsAdapter.ViewHolder> {

    Context context;
    ArrayList<Petanimalsdata> petanimalsdata;
    MediaPlayer mediaPlayer;
    MediaPlayer oldmediaPlayer;
    PetAnimalsAdapter.ViewHolder oldHolder;
    Activity activity;
    Dialog dialog;


    public PetAnimalsAdapter(Context context, ArrayList<Petanimalsdata> petanimalsdata) {
        this.context = context;
        this.petanimalsdata = petanimalsdata;
        this.activity = (Activity) context;
    }

    public class ViewHolder extends RecyclerView.ViewHolder {
        ImageView pet_image, play_icon, pause_icon;
        TextView pet_name;

        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            pet_image = itemView.findViewById(R.id.animal_image);
            pet_name = itemView.findViewById(R.id.animal_name);
    ...
    @NonNull
    @Override
    public PetAnimalsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull PetAnimalsAdapter.ViewHolder holder, @SuppressLint("RecyclerView") int i) {

        holder.itemView.setTag(petanimalsdata.get(i));
        holder.pet_name.setText(petanimalsdata.get(i).getPetname());
        holder.pet_image.setImageResource(petanimalsdata.get(i).getPetimage());
        ...
        holder.play_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    mediaPlayer.setDataSource("https://wirralvideos.s3.us-west-2.amazonaws.com/animal-sounds/domestic-animals/" + petanimalsdata.get(i).getPetsound());
//                    PlaypopDialig();
                    mediaPlayer.prepare();
                    mediaPlayer.start();
        ...
        holder.pet_name.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String Url = ("https://wirralvideos.s3.us-west-2.amazonaws.com/animal-sounds/domestic-animals/" + petanimalsdata.get(i).getPetsound());

                Intent intent = new Intent(context, Playscreen.class);

                intent.putExtra("name", petanimalsdata.get(i).getPetname());
                intent.putExtra("image", petanimalsdata.get(i).getPetimage());
